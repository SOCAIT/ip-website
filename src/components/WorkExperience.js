...
const experiences = [
  {
    ...
    detail: "AI for EU-funded projects. Deploying on Kubernetes and cloud. Site Security Officer for the secure room at the Limassol office, security-cleared by the DSA of Cyprus.",
    period: "2021 – Present",
