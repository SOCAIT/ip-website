      ...
      <div className="education-container">
        <div className="education-item">
          <div className="education-logo-column">
            ...
            <div className='education-description-column' >
             ...
             <p className="education-details">Courses: Deep Learning, NLP, Computer Vision, AI Ethics</p>
        ...
        <div className="education-item">
          ...
          <div className='education-description-column' >
             ...
             <p className="education-details">Courses: Data Structures, Algorithms, Machine Learning, Operating Systems</p>
